  ...
  return (
    <Container>
      <Holder>
        ...
        <ShoWSubject
          bg={
            data.subjectTest.charAt(0).toUpperCase() === "E"
              ? "#FDF4E6"
              : data.subjectTest.charAt(0).toUpperCase() === "B"
              ? "#EAF9FF"
              : data.subjectTest.charAt(0).toUpperCase() === "M"
              ? "#EDE8FF"
              : "#FDF4E6"
          }
        >
          ...
          <MyButton to={`student-test-details/${data._id}`}>
            Start Test
          </MyButton>
        </ShoWSubject>
      </Holder>
