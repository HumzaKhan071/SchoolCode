...
const RatingLecture: React.FC<iProps> = ({
  toggle,
  title,
  subTitle,
  mainAction,
  ...
  const updateReportData = async () => {
    console.log(name);
    setShow(true);
    const newUrl = `${url}/api/lecture-rating/${user._id}/${myProps?._id}/creating-lecture-rating`;
    await axios
      .post(newUrl, {
        ratingLecture: name,
      })
