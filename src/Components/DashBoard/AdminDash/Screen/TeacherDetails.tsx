...
function TeacherDetails() {
	...
	const getStudentDetails = async () => {
		await axios.get(`${url}/api/teacher/${id}`).then((res) => {
			...
			<Container>
					...
					<MainHold2>
						<Cont>
							<Tog>
								...
								<span>
									Present class:{" "}
									{studentData?.classes?.map((classProps: any) => (
										<strong>{classProps}</strong>
									))}
								</span>
							</Tog>
              ...
              */}
							...
							<div
								...
								{studentData?.subjectTaken?.map((props: any) => (
					...
					<MainHold2>
						<Cont>
							<div
								...
								<Tog>
									<h5>Students Learning Reports</h5>
									<span>This are all the student learning reports.</span>
								</Tog>
							</div>
						</Cont>
					</MainHold2>
