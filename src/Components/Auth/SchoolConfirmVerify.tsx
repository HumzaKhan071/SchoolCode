...
const SchoolConfirmVerify: React.FC = () => {
	const { id } = useParams();

	useEffect(() => {
		const newURL: string = `${url}api/school/verified/${id}`;
		axios.get(newURL);
	}, []);
	return (
		<Container>
				...
				<Card>
					...
					<Title>
						...
						<TitleSub>
							...
							<br />
							<span>
								<SpanLink to='/login/school'>Sign in Now </SpanLink>
							</span>
						</TitleSub>
					</Title>
...
export default SchoolConfirmVerify;
