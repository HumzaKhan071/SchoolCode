...
const ConfirmTeacherMessage: React.FC = () => {
	const { id } = useParams();

	useEffect(() => {
		const newURL: string = `${url}/api/teacher/verified/${id}`;
		axios.get(newURL);
	}, []);
	return (
		<Container>
				...
				<Card>
					...
					<Title>
						...
						<TitleSub>
							...
							<br />
							<span>
								<SpanLink to='/login/teacher'>Sign in Now </SpanLink>
							</span>
						</TitleSub>
					</Title>
...
export default ConfirmTeacherMessage;
